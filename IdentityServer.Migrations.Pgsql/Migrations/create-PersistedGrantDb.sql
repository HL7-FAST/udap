...
VALUES ('20240112011503_InitialInitialIdentityServerPersistedGrantDbMigration', '10.0.11');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20240206182446_Update_Duende_v7_0InitialIdentityServerPersistedGrantDbMigration', '10.0.11');
...
CREATE TABLE "SamlLogoutSessionRequestIndices" (
    ...
    CONSTRAINT "FK_SamlLogoutSessionRequestIndices_SamlLogoutSessions_SamlLogo~" FOREIGN KEY ("SamlLogoutSessionId") REFERENCES "SamlLogoutSessions" ("Id") ON DELETE CASCADE
);
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260820162830_Update_Duende_v8_0InitialIdentityServerPersistedGrantDbMigration', '10.0.11');
