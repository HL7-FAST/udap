...
VALUES ('20240112011459_InitialIdentityServerConfigurationDbMigration', '10.0.11');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20240206182441_Update_Duende_v7_0IdentityServerConfigurationDbMigration', '10.0.11');
...
CREATE TABLE "SamlServiceProviders" (
    ...
    "Description" character varying(1000),
    "Enabled" boolean NOT NULL,
    "ClockSkewSeconds" double precision,
    "RequestMaxAgeSeconds" double precision,
    "AssertionLifetimeSeconds" double precision,
    "RequireSignedAuthnRequests" boolean,
    "RequireSignedLogoutResponses" boolean,
    "AllowIdpInitiated" boolean NOT NULL,
    "DefaultNameIdFormat" character varying(2000),
    "EmailNameIdClaimType" character varying(200),
    "SigningBehavior" integer,
    "AllowedSignatureAlgorithms" text[],
    "Created" timestamp with time zone NOT NULL,
    "Updated" timestamp with time zone,
    "LastAccessed" timestamp with time zone,
    "NonEditable" boolean NOT NULL,
...
CREATE TABLE "SamlAssertionConsumerServices" (
    ...
    CONSTRAINT "FK_SamlAssertionConsumerServices_SamlServiceProviders_SamlServ~" FOREIGN KEY ("SamlServiceProviderId") REFERENCES "SamlServiceProviders" ("Id") ON DELETE CASCADE
);

CREATE TABLE "SamlAuthnContextMappings" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "OidcValue" character varying(250) NOT NULL,
    "SamlAuthnContextClassRef" character varying(500) NOT NULL,
    "SamlServiceProviderId" integer NOT NULL,
    CONSTRAINT "PK_SamlAuthnContextMappings" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SamlAuthnContextMappings_SamlServiceProviders_SamlServicePr~" FOREIGN KEY ("SamlServiceProviderId") REFERENCES "SamlServiceProviders" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "SamlClaimMappings" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "ClaimType" character varying(250) NOT NULL,
    "SamlAttributeName" character varying(250) NOT NULL,
    "SamlServiceProviderId" integer NOT NULL,
...
CREATE TABLE "SamlRequestedClaimTypes" (
    ...
    CONSTRAINT "FK_SamlRequestedClaimTypes_SamlServiceProviders_SamlServicePro~" FOREIGN KEY ("SamlServiceProviderId") REFERENCES "SamlServiceProviders" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "SamlSingleLogoutServices" (
    ...
    CONSTRAINT "FK_SamlSingleLogoutServices_SamlServiceProviders_SamlServicePr~" FOREIGN KEY ("SamlServiceProviderId") REFERENCES "SamlServiceProviders" ("Id") ON DELETE CASCADE
);
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260820162826_Update_Duende_v8_0IdentityServerConfigurationDbMigration', '10.0.11');
